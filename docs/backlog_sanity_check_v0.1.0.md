...
- MCP-US-055 is `In Review`: v0.17.0 verbind Logic/USB-MIDI, D1 en veilige I2S op host met 125 groen toetse; menslike Logic/HIL hoorbaarheid bly die closure-hek.
