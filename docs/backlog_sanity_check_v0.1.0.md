...
- MCP-US-055 is `In Review`: v0.17.3 verbind Logic/USB-MIDI, D1 en veilige I2S op host met 128 groen toetse; die impediment-fix behou die idle I2S-silence fix en voeg HIL audition gain, `minimum_note_velocity=64`, `D1_MIDI_INPUT_STATUS=OPEN` plus `D1_AUDIO_EVENT=audible_note` by. Menslike Logic/HIL hoorbaarheid bly die closure-hek.
