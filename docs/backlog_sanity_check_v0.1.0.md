...
- MCP-US-055 is `In Review`: v0.17.2 verbind Logic/USB-MIDI, D1 en veilige I2S op host met 127 groen toetse; die impediment-fix stop idle I2S-silence en voeg `D1_MIDI_INPUT_STATUS=OPEN` plus `D1_AUDIO_EVENT=audible_note` by. Menslike Logic/HIL hoorbaarheid bly die closure-hek.
