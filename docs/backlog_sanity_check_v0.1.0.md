...
- MCP-US-055 is `In Review`: v0.17.4 verbind Logic/USB-MIDI, D1 en veilige I2S op host met 128 groen toetse; die impediment-fix behou die HIL audition gain en gebruik diagnose-gelyke timed I2S playback met square audition default. Menslike Logic/HIL hoorbaarheid bly die closure-hek.
