...
| MCP-US-055 | macOS Logic Pro Audible D1 Acceptance | MVP-Must (P0 Impediment) | US-003, US-007, US-009, US-014, US-016, US-063, US-075, US-077, US-078, US-079 | v0.17.8 verbind USB-MIDI, D1 en veilige I2S op host, maar sewe menslike HIL-pogings het nie betroubare realtime Logic-klank bewys nie. Closure wag op die persistent-audio-graph rebaseline en daarna 'n Product Owner HIL-pass |
...
| MCP-US-079 | Persistent Synthio Audio Graph Spike | MVP-Enabler (Next / P0) | US-016, US-077, US-078, ADR-004 | Open I2S een keer, koppel `synthio.Synthesizer` een keer met `audio.play(synth)`, en laat Logic NoteOn/NoteOff net `press`/`release` state verander. Geen `I2SOut.play/stop` op die MIDI hot path nie; 20 NoteOns moet hoorbaar realtime wees sonder 12-20s backlog |
