...
class ConfigurationDefaults:
    def __init__(self):
        self._values = {
            ...
            "hil.mvp.enabled": False,
            "hil.mvp.note": 60,
            "hil.mvp.velocity": 100,
            "hil.mvp.average_limit_ms": 25,
            "hil.mvp.maximum_limit_ms": 100,
            "hil.mvp.single_event_limit_ms": 250,
            "hil.mvp.fail_limit_ms": 1000,
            "hil.mvp.critical_limit_ms": 10000,
            "wifi.mode": "auto",
        }
...
class EnvironmentSettingsSource:
    def __init__(self, getter):
        ...
        self._environment_keys = {
            ...
            "hil.mvp.enabled": "HIL_MVP_001_ENABLED",
            "hil.mvp.note": "HIL_MVP_001_NOTE",
            "hil.mvp.velocity": "HIL_MVP_001_VELOCITY",
            "hil.mvp.average_limit_ms": "HIL_MVP_001_AVERAGE_LIMIT_MS",
            "hil.mvp.maximum_limit_ms": "HIL_MVP_001_MAXIMUM_LIMIT_MS",
            "hil.mvp.single_event_limit_ms": "HIL_MVP_001_SINGLE_EVENT_LIMIT_MS",
            "hil.mvp.fail_limit_ms": "HIL_MVP_001_FAIL_LIMIT_MS",
            "hil.mvp.critical_limit_ms": "HIL_MVP_001_CRITICAL_LIMIT_MS",
            "wifi.mode": "WIFI_MODE",
            "wifi.ssid": "WIFI_SSID",
