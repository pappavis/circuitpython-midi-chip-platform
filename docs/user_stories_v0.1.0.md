...
| MCP-US-055 | macOS Logic Pro Audible D1 Acceptance | MVP-Must (In Review) | US-003, US-007, US-009, US-014, US-016, US-063, US-075 | v0.17.4 verbind USB-MIDI, D1 en veilige I2S; 128 hosttoetse slaag. I2S runtime playback gebruik nou die werkende diagnosepatroon met square audition default. Closure wag op Product Owner HIL: Logic kies die bord as External MIDI destination en die gebruiker hoor D1 |
