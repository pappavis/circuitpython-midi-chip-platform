...
- MCP-US-055 is `In Review`: v0.17.1 verbind Logic/USB-MIDI, D1 en veilige I2S op host met 126 groen toetse; die impediment-fix voeg `D1_AUDIO_EVENT=audible_note` by. Menslike Logic/HIL hoorbaarheid bly die closure-hek.
