...
class TestConfigurationDefaults:
    def test_public_defaults_preserve_approved_mono_i2s_profile(self) -> None:
        ...
        assert snapshot.get("synth.d1.fast_boot_mode") is True
        ...
        assert snapshot.get("synth.d1.minimum_note_seconds") == 0.05
        ...
        assert snapshot.get("synth.d1.event_logging") == "summary"
    ...
    def test_device_settings_example_quotes_non_integer_values_for_circuitpython_10(self) -> None:
        ...
        assert 'D1_FAST_BOOT_MODE = "true"' in settings_example
        ...
        assert 'D1_MINIMUM_NOTE_SECONDS = "0.05"' in settings_example
        ...
        assert 'D1_EVENT_LOGGING = "summary"' in settings_example
