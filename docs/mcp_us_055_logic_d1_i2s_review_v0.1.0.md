...
| REGRESSION | 131 pytest-toetse slaag; architecture-toetse bevestig geen globals, geen modulefunksies en geen module-level hardeware-imports |
...
D1_REALTIME_MIDI_NOTE=note_on;channel=1;note=...;velocity=...;frequency_hz=...
...
| Release/Documentation | Berei `v0.17.5` as In Review voor en hou US-057 vir finale release/burn-in. |
