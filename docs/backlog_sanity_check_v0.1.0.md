...
- MCP-US-055 is `In Review`: v0.17.6 verbind Logic/USB-MIDI, D1 en veilige I2S op host met 131 groen toetse; die P0-impedimentfix behou die HIL audition gain en gebruik 'n latched RawSample-tone soos die hoorbare standalone I2S-diagnose. Menslike Logic/HIL hoorbaarheid bly die closure-hek.
