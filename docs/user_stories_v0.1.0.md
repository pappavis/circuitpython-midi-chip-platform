...
| MCP-US-055 | macOS Logic Pro Audible D1 Acceptance | MVP-Must (In Review) | US-003, US-007, US-009, US-014, US-016, US-063, US-075 | v0.17.2 verbind USB-MIDI, D1 en veilige I2S; 127 hosttoetse slaag. Idle stuur nie meer silence na I2S nie; kort Logic-notes kry `D1_AUDIO_EVENT=audible_note`. Closure wag op Product Owner HIL: Logic kies die bord as External MIDI destination en die gebruiker hoor D1 |
